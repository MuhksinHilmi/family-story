    ...
    <div className="min-h-screen bg-[#F5F0E8] p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-[#6B5B45]">Keluarga yang ingin bergabung ke Circle Family Anda.</p>
        </div>
        ...
        {requests.length > 0 ? (
              ...
              <Card key={req.id} className="bg-[#FDFAF5] border-[#D4C4A8]">
                <CardContent className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-[#3B2F1E]">{req.full_name}</p>
                      <p className="text-xs text-[#6B5B45]">{req.family_name || 'Keluarga tanpa nama'}</p>
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="bg-[#4A7C59] hover:bg-[#2E5239] text-white">
                      Terima
                    </Button>
                    <Button size="sm" variant="outline" className="border-[#D4C4A8] text-[#6B5B45]">
                      Tolak
                    </Button>
                  </div>
                </CardContent>
          ...
          <div className="text-center py-20 space-y-4">
            ...
            <h3 className="text-lg font-bold text-[#3B2F1E]">Tidak Ada Permintaan</h3>
