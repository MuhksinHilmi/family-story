...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const familyUuid = formData.get('family_uuid') as string;
    ...
    const uploadDir = path.join(process.cwd(), 'public', 'uploads', 'feeds', familyUuid);
    ...
    const publicUrl = `/uploads/feeds/${familyUuid}/${fileName}`;
