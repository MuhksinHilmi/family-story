        ...
        <div className="ck-feature-grid">
          ...
          <div>
            ...
            <p className="ck-feature-body reveal-up reveal-delay-2">
              Bukan sekadar diagram nama dan tanggal lahir. Di sini kamu bisa
              mencatat setiap orang — lengkap dengan cerita, foto, pekerjaan,
              dan relasinya ke anggota keluarga lain. Dari generasi kakek buyut
              sampai cucu yang baru lahir.
            </p>
            <p
              className="ck-feature-body reveal-up reveal-delay-2"
              style={{ marginBottom: "1.5rem" }}
            >
              Visualisasi interaktif yang bisa di-zoom bebas. Semua terhubung —
              dari keluarga inti sampai keluarga besar.
            </p>
            <Link
              href="/auth/register"
              className="ck-feature-link reveal-up reveal-delay-3"
            >
        ...
        <div className="ck-feature-grid reverse">
          ...
          <div>
            ...
            <p className="ck-feature-body reveal-up reveal-delay-2">
              ...
              Semua bisa disimpan di sini — sebagai kenangan keluarga, bukan
              konten untuk dunia.
            </p>
            <p
              className="ck-feature-body reveal-up reveal-delay-2"
              style={{ marginBottom: "1.5rem" }}
            >
              Hanya anggota keluarga yang bisa melihat. Privat, aman, dan
              tersimpan selamanya.
            </p>
            <Link
              href="/auth/register"
...
const BUBBLES = [
  {
    side: "left",
    name: "Nenek",
    text: "Jangan lupa sholat Jumat ya, Nak 🤲",
    delay: "0.2s",
  },
  {
    side: "left",
    name: "Ayah",
    text: "Siap Bu, sudah dalam perjalanan 🕌",
    delay: "0.6s",
  },
  {
    side: "left",
    name: "Kakak",
    text: "Nanti makan siang di rumah nenek ya semua?",
    delay: "1.0s",
  },
  {
    side: "right",
    name: "Kamu",
    text: "Ayo! Saya bawa es krim 🍦",
    delay: "1.4s",
  },
  {
    side: "left",
    name: "Ibu",
    text: "Sudah masak opor dari tadi 😄",
    delay: "1.8s",
  },
];
      ...
      <div className="ck-container">
        <div className="ck-feature-grid">
          ...
          <div>
            ...
            <p className="ck-feature-body reveal-up reveal-delay-2">
              Grup WhatsApp keluarga ramai — tapi pesan penting tenggelam di
              antara forward-an dan meme. Di sini berbeda.
            </p>
            <p
              className="ck-feature-body reveal-up reveal-delay-2"
              style={{ marginBottom: "1.5rem" }}
            >
              ...
              sub-grup tertentu. Semua terkontrol, rapi, dan hanya bisa diakses
              oleh yang benar-benar keluarga.
            </p>
            <Link
              href="/auth/register"
              className="ck-feature-link reveal-up reveal-delay-3"
      ...
      <div className="ck-container">
        <div className="ck-feature-grid reverse">
          ...
          <div>
            ...
            <p className="ck-feature-body reveal-up reveal-delay-2">
              Urusan harta waris sering jadi sumber perselisihan keluarga. Bukan
              karena tidak ikhlas — tapi karena tidak tahu cara menghitungnya
              yang benar.
            </p>
            <p
              className="ck-feature-body reveal-up reveal-delay-2"
              style={{ marginBottom: "1.5rem" }}
            >
              Cerita Keluarga membantu menghitung pembagian waris sesuai fiqih
              mawaris Al-Quran. Adil, transparan, dan mudah dipahami semua
              anggota keluarga.
            </p>
            <Link
              href="/auth/register"
          ...
          >
            ...
            >
              Dihitung berdasarkan ilmu faraid (fiqih mawaris) sesuai Al-Quran
              Surat An-Nisa.
            </p>
          </div>
        </div>
      ...
      <div className="ck-container">
        <div className="ck-feature-grid">
          ...
          <div>
            ...
            <p className="ck-feature-body reveal-up reveal-delay-2">
              Keluarga baru dimulai dari perkenalan yang benar. Ta'aruf di sini
              bukan kencan — tapi mempertemukan dua keluarga besar dengan hormat
              dan adab.
            </p>
            <p
              className="ck-feature-body reveal-up reveal-delay-2"
              style={{ marginBottom: "1.5rem" }}
            >
              Dua pohon keluarga yang terpisah, diperkenalkan, dan jika Allah
              izinkan — bergabung menjadi satu keluarga besar.
            </p>
          </div>

          {/* Taaruf visual — gambar dua keluarga */}
          <div
            className="reveal-up reveal-delay-2"
            style={{
              display: "flex",
          ...
          >
            <img
              src="/images/image_taaruf.png"
              alt="Dua keluarga bertemu dalam proses taaruf"
              style={{
                width: "100%",
                maxWidth: 420,
                height: 280,
